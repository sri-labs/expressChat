...
// message in all supported languages
  ath.intl = {
    de_de: {
      message: 'Um diese Web-App zum Home-Bildschirm hinzuzuf체gen, tippen Sie auf %icon und dann <strong>%action</strong>.',
      action: { ios: 'Zum Home-Bildschirm', android: 'Zum Startbildschirm hinzuf체gen', windows: 'Auf Startseite' }
    },
    ...
    es_es: {
      message: 'Para a챰adir esta aplicaci처n web a la pantalla de inicio: pulsa %icon y selecciona <strong>%action</strong>.',
      action: { ios: 'A챰adir a pantalla de inicio', android: 'A챰adir a pantalla de inicio', windows: 'A챰adir a inicio' }
    },

    fr_fr: {
      message: 'Pour ajouter cette application web sur l\'챕cran d\'accueil : Appuyez %icon et s챕lectionnez <strong>%action</strong>.',
      action: { ios: 'Ajouter sur l\'챕cran d\'accueil', android: 'Ajouter 횪 l\'챕cran d\'accueil', windows: '횋pingler 횪 l\'챕cran d\'accueil' }
    },
    ...
    nb_no: {
      message: 'For 책 installere denne appen p책 hjem-skjermen: trykk p책 %icon og deretter <strong>%action</strong>.',
      action: { ios: 'Legg til p책 Hjem-skjerm', android: 'Legg til p책 startsiden', windows: 'fest til start' }
    },
    ...
    sv_se: {
      message: 'F철r att l채gga till denna webbapplikation p책 hemsk채rmen: tryck p책 %icon och d채refter <strong>%action</strong>.',
      action: { ios: 'L채gg till p책 hemsk채rmen', android: 'L채gg til p책 startsk채rmen', windows: 'f채st p책 startsk채rmen' }
    },

    zh_cn: {
      message: '倻귟쫨�듿틪�①쮮凉뤷뒥�념말掠뤷퉽,瑥루궧��%icon, �뜹릮<strong>%action</strong>',
      action: { ios: '�좄눛訝삣콓亮�', android: '�좄눛訝삣콓亮�', windows: '�됦퐦��뒯' }
    },

    zh_tw: {
      message: '倻귟쫨�딀뇡�①쮮凉뤷뒥�념말掠뤷퉽, 獄뗩퍧��%icon, �뜹풄<strong>%action</strong>.',
      action: { ios: '�좄눛訝삣콓亮�', android: '�좄눛訝삣콓亮�', windows: '�됦퐦�잌땿' }
    }
  };
